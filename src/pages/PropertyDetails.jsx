          ...
          <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8'>
            ...
            <form className='flex flex-col gap-y-4'>
              ...
              <div className="">
                ...
                <button className="border border-b-violet-700 text-violet-700 hover:border-violet-500 hover:text-violet-500 rounded p-4 text-sm w-full transition">Call</button>
              </div>
            </form>
          </div>
        </div>
